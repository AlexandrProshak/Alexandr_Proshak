...
import static ru.job4j.task1.presentation.ServletsConstants.ATTRIBUTE_ALL_USERS;
import static ru.job4j.task1.presentation.ServletsConstants.ATTRIBUTE_USER_BY_ID;
import static ru.job4j.task1.presentation.ServletsConstants.PARAMETER_ACTION;
import static ru.job4j.task1.presentation.ServletsConstants.PARAMETER_ACTION_ADD;
import static ru.job4j.task1.presentation.ServletsConstants.PARAMETER_USER_ID;
import static ru.job4j.task1.presentation.ServletsConstants.PARAMETER_USER_NAME;
import static ru.job4j.task1.presentation.ServletsConstants.PARAMETER_USER_LOGIN;
import static ru.job4j.task1.presentation.ServletsConstants.PARAMETER_USER_EMAIL;
import static ru.job4j.task1.presentation.ServletsConstants.PARAMETER_ACTION_UPDATE;
import static ru.job4j.task1.presentation.ServletsConstants.PARAMETER_ACTION_DELETE;
import static ru.job4j.task1.presentation.ServletsConstants.PARAMETER_ACTION_FIND_BY_ID;
